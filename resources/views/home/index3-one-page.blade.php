            ...
            <div class="listing-three__carousel owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Maruti Ertiga VXI CNG</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Maruti Swift LXI</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Mahindra Scorpio S11</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Mahindra Thar 4x4 Diesel</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Hyundai Verna Petrol</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Hyundai i20</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                 ...
                 <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Hyundai i10</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Maruti Swift Dzire</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="{{ route('listing-single') }}">Aura CNG</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
