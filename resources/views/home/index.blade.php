                            ...
                            <div class="listing-one__carousel owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <div class="listing-one__single">
                                        ...
                                        <div class="listing-one__content">
                                            <h3 class="listing-one__title"><a href="{{ route('listing-single') }}">Kia
                                                    Soul
                                                    2025</a></h3>
                                            <div class="listing-one__meta-box-info">
                                                <ul class="list-unstyled listing-one__meta">
                                ...
                                <div class="item">
                                    <div class="listing-one__single">
                                        ...
                                        <div class="listing-one__content">
                                            ...
                                            <div class="listing-one__btn-box">
                                                <a href="{{ route('listing-single') }}" class="thm-btn">Details
            ...
            <div class="popular-car-one__carousel owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="popular-car-one__single">
                        ...
                        <div class="popular-car-one__single-inner">
                            <h4 class="popular-car-one__title"><a href="{{ route('car-list-v-2') }}">Crossover</a>
                            </h4>
                        </div>
                                                ...
                                                <div class="team-one__buttons-content">
                                                    <div class="team-one__buttons-title-box">
                                                        <h4 class="team-one__buttons-title"><a
                                                                href="{{ route('driver-details') }}">Olivia Grace</a>
                                                        </h4>
                                        ...
                                        <div class="team-one__buttons">
                                            ...
                                            <div class="team-one__buttons-content-box">
                                                ...
                                                <div class="team-one__buttons-content">
                                                    <div class="team-one__buttons-title-box">
                                                        <h4 class="team-one__buttons-title"><a
                                                                href="{{ route('driver-details') }}">Olivia Smith</a>
                                                        </h4>
                                        ...
                                        <div class="team-one__buttons">
                                            ...
                                            <div class="team-one__buttons-content-box">
                                                ...
                                                <div class="team-one__buttons-content">
                                                    <div class="team-one__buttons-title-box">
                                                        <h4 class="team-one__buttons-title"><a
                                                                href="{{ route('driver-details') }}">James Olivia</a>
                                                        </h4>
                                        ...
                                        <div class="team-one__buttons">
                                            ...
                                            <div class="team-one__buttons-content-box">
                                                ...
                                                <div class="team-one__buttons-content">
                                                    <div class="team-one__buttons-title-box">
                                                        <h4 class="team-one__buttons-title"><a
                                                                href="{{ route('driver-details') }}">James Vince</a>
                                                        </h4>
                ...
                <div class="item">
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content">
                            ...
                            <h3 class="blog-one__title"><a href="{{ route('blog-details') }}">Rental cost of sport and
                                    other
                                    cars</a></h3>
                            <p class="blog-one__text">Car Is Where Early Adopters And Innovation Seekers Find Lively
                                Imaginative Tech.</p>
                ...
                <div class="item">
                    <div class="blog-one__single">
                        ...
                        <div class="blog-one__content">
                            ...
                            <h3 class="blog-one__title"><a href="{{ route('blog-details') }}">Penalties for violating
                                    the
