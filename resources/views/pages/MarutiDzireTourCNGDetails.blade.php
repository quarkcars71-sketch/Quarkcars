...
@section('title', 'Maruti Dzire Tour CNG Details || Quarkcars')
...
@section('content')
    ...
    <x-pageHeader title="Maruti Dzire Tour CNG" subtitle="Dzire Tour S CNG" />
        ...
        <div class="container">
            <div class="listing-single__top">
                <div class="listing-single__top-left">
                    <h3 class="listing-single__title">Maruti Dzire Tour CNG</h3>
                    <p class="listing-single__sub-title">1.2L Tour S CNG 4dr FWD Manual Sedan</p>
                                        ...
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="{{ asset('assets/images/listing/listing-3-12.png') }}"
                                                        alt="Maruti Dzire Tour CNG">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-7 col-lg-7">
                                            <div class="listing-single__right">
                                                <h3 class="listing-single__title-two">Maruti Dzire Tour CNG – Commercial Taxi with Best-in-Class Mileage</h3>
                                                ...
                                                <ul class="list-unstyled listing-single__meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <p>Fleet Code:<a href="#"><span>QC-DZIRETOUR-01</span></a></p>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="swiper-slide">
                                <div class="listing-single__img-holder-box">
                                    <div class="listing-single__img-holder">
                                        <img src="{{ asset('assets/images/listing/listing-3-12.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="listing-single__bottom-left">
                            ...
                            <div class="listing-single__feature">
                                ...
                                <div class="listing-single__feature-points-box">
                                    ...
                                    <div class="listing-single__feature-point-single">
                                        <h4 class="listing-single__feature-point-title">Fleet Features</h4>
                                        <ul class="list-unstyled listing-single__feature-point">
                                            <li>
                                                <div class="icon">
                                                    <span class="icon-cheack"></span>
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="{{ route('maruti-dzire-tour-cng-details') }}" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
