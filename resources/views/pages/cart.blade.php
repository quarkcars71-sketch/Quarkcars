...
@section('title', 'Cart || QuarkCars')

@section('content')

    <x-pageHeader title="Cart" subtitle="Cart" />
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                ...
                                                <h3><a href="{{ route('product-details') }}">Gree Air Conditioner</a></h3>
                                            </div>
                                        </td>
                                        <td>$10.99</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                ...
                                                <h3><a href="{{ route('product-details') }}">Pliers | Cutting, Gripping</a>
                                                </h3>
                                            </div>
                                        </td>
                                        <td>$10.99</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                ...
                                                <h3><a href="{{ route('product-details') }}">Gear and wrench</a></h3>
                                            </div>
                                        </td>
                                        <td>$10.99</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="product-box">
                                                ...
                                                <h3><a href="{{ route('product-details') }}">Nut Driver</a></h3>
                                            </div>
                                        </td>
                                        <td>$10.99</td>
                                        <td>
