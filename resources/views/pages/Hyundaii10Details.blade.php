...
@section('title', 'Hyundai i10 Details || Quarkcars')
...
@section('content')
    ...
    <x-pageHeader title="Hyundai i10" subtitle="i10 Magna Petrol" />
                                        ...
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="{{ asset('assets/images/listing/listing-3-7.png') }}"
                                                        alt="Hyundai i10">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="listing-single__img-holder-box">
                                    <div class="listing-single__img-holder">
                                        <img src="{{ asset('assets/images/listing/listing-3-7.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="{{ route('hyundai-i10-details') }}" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
