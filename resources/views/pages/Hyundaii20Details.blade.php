...
@section('title', 'Hyundai i20 Details || Quarkcars')
...
@section('content')
    ...
    <x-pageHeader title="Hyundai i20" subtitle="i20 Asta Petrol" />
                                        ...
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="{{ asset('assets/images/listing/listing-3-6.png') }}"
                                                        alt="Hyundai i20">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="{{ route('hyundai-i20-details') }}" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
