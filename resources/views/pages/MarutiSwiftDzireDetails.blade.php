...
@section('title', 'Maruti Swift Dzire Details || Quarkcars')
...
@section('content')
    ...
    <x-pageHeader title="Maruti Swift Dzire" subtitle="Dzire VXI CNG Sedan" />
                                        ...
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="{{ asset('assets/images/listing/listing-3-8.png') }}"
                            ...
                            <div class="swiper-slide">
                                <div class="listing-single__img-holder-box">
                                    <div class="listing-single__img-holder">
                                        <img src="{{ asset('assets/images/listing/listing-3-8.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="{{ route('maruti-swift-dzire-details') }}" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
