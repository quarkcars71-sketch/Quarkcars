...
@section('title', 'Swift LXI Details || Quarkcars')
...
@section('content')
    ...
    <x-pageHeader title="Swift LXI Details" subtitle="Swift LXI Petrol" />
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="{{ route('swift-lxi-details') }}" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
