...
@section('title', 'Checkout || QuarkCars')

@section('content')


    <x-pageHeader title="Checkout" subtitle="Checkout" />
                    ...
                    <div class="sidebar-order-summary">
                        ...
                        <div class="sidebar-order-summary__bottom">
                            ...
                            <div class="sidebar-order-summary__checked">
                                ...
                                <label for="skipper2"><span></span>I have read and agree to the website <a href="#">terms
