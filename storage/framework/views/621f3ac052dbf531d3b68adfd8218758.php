                    ...
                    <div class="car-listing-page-three__left">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="listing-three__single">
                                    <div class="listing-three__img">
                                        <img src="<?php echo e(asset('assets/images/listing/listing-1-13(1).png')); ?>" alt="">
                                        <div class="listing-three__brand-name">
                                            <p>Toyota</p>
                                        </div>
                                    </div>
                                    <div class="listing-three__content">
                                        <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Innova</a></h3>
                                        <div class="listing-three__meta-box-info">
                                            <ul class="list-unstyled listing-three__meta">
                                                <li>
                                                    <div class="icon">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="listing-three__single">
                                    <div class="listing-three__img">
                                        <img src="<?php echo e(asset('assets/images/listing/listing-1-14(1).png')); ?>" alt="">
                                        <div class="listing-three__brand-name">
                                            <p>Toyota</p>
                                        </div>
                                    </div>
                                    <div class="listing-three__content">
                                        <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Innova Crysta</a></h3>
                                        <div class="listing-three__meta-box-info">
                                            <ul class="list-unstyled listing-three__meta">
                                                <li>
                                                    <div class="icon">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="listing-three__single">
                                    <div class="listing-three__img">
                                        <img src="<?php echo e(asset('assets/images/listing/listing-1-15(1).png')); ?>" alt="">
                                        <div class="listing-three__brand-name">
                                            <p>Toyota</p>
                                        </div>
                                    </div>
                                    <div class="listing-three__content">
                                        <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Toyota Fortuner</a></h3>
                                        <div class="listing-three__meta-box-info">
                                            <ul class="list-unstyled listing-three__meta">
                                                <li>
                                                    <div class="icon">
