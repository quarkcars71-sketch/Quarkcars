<?php $__env->startSection('title', 'Hyundai i20 Details || Quarkcars'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Hyundai i20','subtitle' => 'i20 Asta Petrol']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Hyundai i20','subtitle' => 'i20 Asta Petrol']); ?>
        ...
        <div class="container">
            <div class="listing-single__top">
                <div class="listing-single__top-left">
                    <h3 class="listing-single__title">Hyundai i20</h3>
                    <p class="listing-single__sub-title">1.2L Asta 5dr FWD Manual Hatchback</p>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="<?php echo e(asset('assets/images/listing/listing-3-6.png')); ?>"
                                                        alt="Hyundai i20">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-7 col-lg-7">
                                            <div class="listing-single__right">
                                                <h3 class="listing-single__title-two">Hyundai i20 – Premium Hatchback with Style & Technology</h3>
                                                ...
                                                <ul class="list-unstyled listing-single__meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <p>Fleet Code:<a href="#"><span>QC-i20-01</span></a></p>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="swiper-slide">
                                <div class="listing-single__img-holder-box">
                                    <div class="listing-single__img-holder">
                                        <img src="<?php echo e(asset('assets/images/listing/listing-3-6.png')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="listing-single__bottom-left">
                            ...
                            <div class="listing-single__description">
                                ...
                                <p class="listing-single__description-text-1">The Hyundai i20 is a premium hatchback that redefines style and sophistication in its segment. With its bold parametric jewel pattern grille, sharp LED projector headlamps, and distinctive Z-shaped LED tail lamps, the i20 makes a strong style statement. The spacious cabin offers segment-leading space with premium dual-tone interiors and a host of advanced features.</p>
                                <p class="listing-single__description-text-2">Powered by the refined 1.2L Kappa petrol engine producing 82 bhp, the i20 delivers a smooth and efficient driving experience with a claimed mileage of 20.3 km/l. The comfortable suspension setup, light steering, and well-insulated cabin make it an ideal choice for both city commutes and highway journeys. With best-in-class safety features and Hyundai's reliable after-sales service, the i20 offers peace of mind ownership.</p>
                            </div>
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="<?php echo e(route('hyundai-i20-details')); ?>" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/pages/Hyundaii20Details.blade.php ENDPATH**/ ?>