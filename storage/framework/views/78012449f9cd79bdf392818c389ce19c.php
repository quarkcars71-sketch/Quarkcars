<?php $__env->startSection('title', 'Maruti Swift Dzire Details || Quarkcars'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Maruti Swift Dzire','subtitle' => 'Dzire VXI CNG Sedan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Maruti Swift Dzire','subtitle' => 'Dzire VXI CNG Sedan']); ?>
        ...
        <div class="container">
            <div class="listing-single__top">
                <div class="listing-single__top-left">
                    <h3 class="listing-single__title">Maruti Swift Dzire</h3>
                    <p class="listing-single__sub-title">1.2L VXI CNG 4dr FWD Manual Sedan</p>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="<?php echo e(asset('assets/images/listing/listing-3-8.png')); ?>"
                                        ...
                                        <div class="col-xl-7 col-lg-7">
                                            <div class="listing-single__right">
                                                <h3 class="listing-single__title-two">Maruti Swift Dzire – India's Favorite Compact Sedan</h3>
                                                ...
                                                <ul class="list-unstyled listing-single__meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <p>Fleet Code:<a href="#"><span>QC-DZIRE-01</span></a></p>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="swiper-slide">
                                <div class="listing-single__img-holder-box">
                                    <div class="listing-single__img-holder">
                                        <img src="<?php echo e(asset('assets/images/listing/listing-3-8.png')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="listing-single__bottom-left">
                            ...
                            <div class="listing-single__description">
                                ...
                                <p class="listing-single__description-text-1">The Maruti Swift Dzire is India's most loved compact sedan, combining the agility of a hatchback with the comfort and prestige of a sedan. The sleek exterior design features a bold chrome grille, swept-back projector headlamps, and elegant LED tail lamps. With a boot space of 378 liters, the Dzire offers ample luggage capacity for family trips and airport runs.</p>
                                <p class="listing-single__description-text-2">Powered by Maruti's proven 1.2L DualJet VVT engine with factory-fitted S-CNG kit, the Dzire VXI CNG delivers an outstanding mileage of 31.12 km/kg. The dual interdependent ECUs ensure optimal performance and safety in both petrol and CNG modes. The spacious cabin features premium dual-tone interiors, a 7-inch SmartPlay Studio touchscreen, and excellent rear seat comfort with AC vents, making every journey a pleasant experience.</p>
                            </div>
                                    ...
                                    <div class="listing-single__feature-point-single">
                                        ...
                                        <ul class="list-unstyled listing-single__feature-point">
                                            ...
                                            <li>
                                                ...
                                                <div class="text">
                                                    <p>7-inch Touchscreen Display</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="icon">
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="<?php echo e(route('maruti-swift-dzire-details')); ?>" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/pages/MarutiSwiftDzireDetails.blade.php ENDPATH**/ ?>