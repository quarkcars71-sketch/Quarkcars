<?php $__env->startSection('title', 'Maruti Baleno Details || Quarkcars'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Maruti Baleno','subtitle' => 'Baleno Zeta Petrol']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Maruti Baleno','subtitle' => 'Baleno Zeta Petrol']); ?>
        ...
        <div class="container">
            <div class="listing-single__top">
                <div class="listing-single__top-left">
                    <h3 class="listing-single__title">Maruti Baleno</h3>
                    <p class="listing-single__sub-title">1.2L Zeta 5dr FWD Manual Hatchback</p>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="<?php echo e(asset('assets/images/listing/listing-3-10.png')); ?>"
                                                        alt="Maruti Baleno">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-7 col-lg-7">
                                            <div class="listing-single__right">
                                                <h3 class="listing-single__title-two">Maruti Baleno – Premium Hatchback with Nexa Experience</h3>
                                                ...
                                                <ul class="list-unstyled listing-single__meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <p>Fleet Code:<a href="#"><span>QC-BALENO-01</span></a></p>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="swiper-slide">
                                <div class="listing-single__img-holder-box">
                                    <div class="listing-single__img-holder">
                                        <img src="<?php echo e(asset('assets/images/listing/listing-3-10.png')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="listing-single__bottom-left">
                            ...
                            <div class="listing-single__description">
                                ...
                                <p class="listing-single__description-text-1">The Maruti Baleno is a premium hatchback that redefines the segment with its sophisticated design language and premium features. The sleek exterior features a bold grille, LED projector headlamps with DRLs, and stylish alloy wheels. The spacious cabin offers best-in-class interior space with premium dual-tone interiors, making every journey comfortable for all occupants.</p>
                                <p class="listing-single__description-text-2">Powered by the advanced 1.2L DualJet VVT engine with idle start-stop technology, the Baleno delivers an impressive mileage of 22.35 km/l along with 89 bhp of power. The refined suspension setup offers a comfortable ride quality while the light steering makes city driving effortless. With features like the SmartPlay Pro+ infotainment system, heads-up display, and 360-degree camera, the Baleno offers a truly premium driving experience.</p>
                            </div>
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="<?php echo e(route('maruti-baleno-details')); ?>" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/pages/MarutiBalenoDetails.blade.php ENDPATH**/ ?>