<?php $__env->startSection('title', 'Mahindra Scorpio S11 Details || Quarkcars'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Mahindra Scorpio S11','subtitle' => 'Scorpio S11 Diesel SUV']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Mahindra Scorpio S11','subtitle' => 'Scorpio S11 Diesel SUV']); ?>
        ...
        <div class="container">
            <div class="listing-single__top">
                <div class="listing-single__top-left">
                    <h3 class="listing-single__title">Mahindra Scorpio S11</h3>
                    <p class="listing-single__sub-title">2.2L mHawk Diesel 4WD Manual SUV</p>
                                        ...
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="<?php echo e(asset('assets/images/listing/listing-3-4(1).png')); ?>"
                                                        alt="Mahindra Scorpio S11">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="listing-single__right">
                                                ...
                                                <ul class="list-unstyled listing-single__meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <p>Fleet Code:<a href="#"><span>QC-SCORPIO-S11-01</span></a></p>
                                                        </div>
                                                    </li>
                                                </ul>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="listing-single__bottom-left">
                            ...
                            <div class="listing-single__description">
                                ...
                                <p class="listing-single__description-text-1">The Mahindra Scorpio S11 is the flagship variant of India's most iconic SUV. Built on a rugged ladder-frame chassis, the Scorpio S11 is designed to conquer any terrain. The 2.2L mHawk diesel engine is a powerhouse, delivering 140 bhp and a massive 320 Nm of torque, ensuring effortless performance whether you're on the highway or exploring off-road trails.</p>
                                <p class="listing-single__description-text-2">With its commanding road presence, premium interiors, and advanced 4WD system with shift-on-the-fly technology, the Scorpio S11 is perfect for family road trips, adventure getaways, and anyone who demands both luxury and rugged capability in one package. The 7-seater configuration ensures ample space for the whole family and luggage.</p>
                            </div>
                                    ...
                                    <div class="listing-single__feature-point-single">
                                        ...
                                        <ul class="list-unstyled listing-single__feature-point">
                                            ...
                                            <li>
                                                ...
                                                <div class="text">
                                                    <p>7-inch Touchscreen Infotainment</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="icon">
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="<?php echo e(route('mahindra-scorpio-s11-details')); ?>" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/pages/MahindraScorpioS11Details.blade.php ENDPATH**/ ?>