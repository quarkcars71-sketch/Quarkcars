...
<footer class="site-footer">
    <div class="site-footer__bg"
        style="background-image: url(<?php echo e(asset('assets/images/backgrounds/site-footer-bg.jpg')); ?>);">
    </div>
                        ...
                        <div class="footer-widget__about">
                            <div class="footer-widget__about-logo">
                                <a href="<?php echo e(route('index')); ?>"><img
                                        src="<?php echo e(asset('assets/images/resources/footer-logo(3).png')); ?>" alt=""></a>
                            </div>
                    ...
                    <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="footer-widget__links">
                            ...
                            <ul class="footer-widget__links-list list-unstyled">
                                ...
                                <li><a href="<?php echo e(route('drivers')); ?>">Our Drivers</a></li>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="footer-widget__services">
                            ...
                            <ul class="footer-widget__links-list list-unstyled">
                                ...
                                <li><a href="<?php echo e(route('taxi-services')); ?>">Taxi Services</a></li>
                                <!-- <li><a href="<?php echo e(route('swift-vxi-details')); ?>">Dash Transport</a></li> -->
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="site-footer__bottom-inner">
                        ...
                        <div class="site-footer__bottom-menu-box">
                            <ul class="list-unstyled site-footer__bottom-menu">
                                ...
                                <li><a href="<?php echo e(route('cancellation-policy')); ?>">Cancellation Policy</a></li>
                                <li><a href="<?php echo e(route('customer-agreement')); ?>">Customer agreement</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
</div><!-- /.page-wrapper --><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/components/footer_style_one.blade.php ENDPATH**/ ?>