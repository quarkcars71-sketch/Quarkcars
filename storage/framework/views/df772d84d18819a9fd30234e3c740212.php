<?php $__env->startSection('title', 'Hyundai i10 Details || Quarkcars'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Hyundai i10','subtitle' => 'i10 Magna Petrol']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Hyundai i10','subtitle' => 'i10 Magna Petrol']); ?>
        ...
        <div class="container">
            <div class="listing-single__top">
                <div class="listing-single__top-left">
                    <h3 class="listing-single__title">Hyundai i10</h3>
                    <p class="listing-single__sub-title">1.2L Magna 5dr FWD Manual Hatchback</p>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="<?php echo e(asset('assets/images/listing/listing-3-7.png')); ?>"
                                                        alt="Hyundai i10">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-7 col-lg-7">
                                            <div class="listing-single__right">
                                                <h3 class="listing-single__title-two">Hyundai i10 – Compact City Car with Big Features</h3>
                                                ...
                                                <ul class="list-unstyled listing-single__meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text">
                                                            <p>Fleet Code:<a href="#"><span>QC-i10-01</span></a></p>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="swiper-slide">
                                <div class="listing-single__img-holder-box">
                                    <div class="listing-single__img-holder">
                                        <img src="<?php echo e(asset('assets/images/listing/listing-3-7.png')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="listing-single__bottom-left">
                            ...
                            <div class="listing-single__description">
                                ...
                                <p class="listing-single__description-text-1">The Hyundai i10 is a compact city car that delivers big on features and comfort. Its compact dimensions make it perfect for navigating crowded city streets and fitting into tight parking spaces, while the clever interior packaging ensures ample room for five occupants. The stylish exterior design features Hyundai's signature cascading grille and swept-back headlamps.</p>
                                <p class="listing-single__description-text-2">Powered by a refined 1.2L Kappa petrol engine producing 82 bhp, the i10 offers spirited performance with excellent fuel economy of 20.3 km/l. The light steering, tight turning radius, and smooth gearbox make city driving a breeze. With features like a touchscreen infotainment system, steering-mounted controls, and best-in-class safety equipment, the i10 offers premium features at an affordable price point.</p>
                            </div>
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="<?php echo e(route('hyundai-i10-details')); ?>" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
                            ...
                            <div class="listing-single__seller-info listing-single__single-box">
                                ...
                                <div class="listing-single__seller-contact-info">
                                    <ul class="unstyled listing-single__seller-contact-info-list">
                                        <li>
                                            <div class="icon">
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/pages/Hyundaii10Details.blade.php ENDPATH**/ ?>