            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="listing-one__single">
                        ...
                        <div class="listing-one__content">
                            <h3 class="listing-one__title"><a href="<?php echo e(route('listing-single')); ?>">Acura
                                    Sport Version</a></h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="listing-one__single">
                        ...
                        <div class="listing-one__content">
                            <h3 class="listing-one__title"><a href="<?php echo e(route('listing-single')); ?>">Kia Soul
                                    2025</a></h3>
                            <div class="listing-one__meta-box-info">
                                <ul class="list-unstyled listing-one__meta">
                                    <li>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="listing-one__single">
                        ...
                        <div class="listing-one__content">
                            <h3 class="listing-one__title"><a href="<?php echo e(route('listing-single')); ?>">Audi A3
                                    2025 New</a></h3>
                            <div class="listing-one__meta-box-info">
                                <ul class="list-unstyled listing-one__meta">
                                    <li>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="listing-one__single">
                        ...
                        <div class="listing-one__content">
                            <h3 class="listing-one__title"><a href="<?php echo e(route('listing-single')); ?>">Ferrari
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="listing-one__single">
                        ...
                        <div class="listing-one__content">
                            <h3 class="listing-one__title"><a href="<?php echo e(route('listing-single')); ?>">Audi Sport
                                    Version</a></h3>
                            <div class="listing-one__meta-box-info">
                                <ul class="list-unstyled listing-one__meta">
                                    <li>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="listing-one__single">
                        ...
                        <div class="listing-one__content">
                            <h3 class="listing-one__title"><a href="<?php echo e(route('listing-single')); ?>">Toyota
                                    Tacoma 4WD</a></h3>
                            <div class="listing-one__meta-box-info">
                                <ul class="list-unstyled listing-one__meta">
                                    <li>
