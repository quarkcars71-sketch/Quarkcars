    ...
    <section class="banner-one" id="home">
        ...
        <div class="banner-one__shape-1">
            <div class="banner-one__shape-1-bg"
                style="background-image: url(<?php echo e(asset('assets/images/backgrounds/banner-one-shape-1-bg.jpg')); ?>);"></div>
        </div>
...
Travel with comfort, flexibility, and complete control of your trip.</p>
                    <div class="banner-one__btn-box">
                        <a href="<?php echo e(route('about')); ?>" class="thm-btn">Read More<span class="fas fa-arrow-right"></span></a>
                    </div>
                </div>
                <div class="banner-one__img-one" data-aos="slide-left" data-aos-duration="2000">
                    <img src="<?php echo e(asset('assets/images/resources/banner-one-img-1(1).png')); ?>" alt="" class="float-bob-y">
                </div>
            </div>
        </div>
    </section>
...
With a strong focus on customer satisfaction and seamless booking, it ensures a convenient travel experience.</p>
                        <div class="about-three__points-box">
                            ...
                            <div class="about-three__btn-box-and-call-box">
                                <div class="about-three__btn-box">
                                    <a href="<?php echo e(route('about')); ?>" class="about-three__btn thm-btn">Read More<span
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="about-three__img-box">
                                    <div class="about-three__img-1">
                                        <img src="<?php echo e(asset('assets/images/resources/about-three-img-1(1).jpg')); ?>" alt="">
                                    </div>
                                    <div class="about-three__img-2">
                                        <img src="<?php echo e(asset('assets/images/resources/about-three-img-2(1).jpg')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="about-three__satisfied-and-img">
                                    ...
                                    <div class="about-three__img-3">
                                        <img src="<?php echo e(asset('assets/images/resources/about-three-img-3(1).jpg')); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                    <div class="services-three__single">
                        ...
                        <div class="services-three__content">
                            <h3 class="services-three__title"><a href="<?php echo e(route('services')); ?>">Self Drive Rental</a>
                            </h3>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="services-three__single">
                        ...
                        <div class="services-three__content">
                            <h3 class="services-three__title"><a href="<?php echo e(route('services')); ?>">Car Sharing</a>
                            </h3>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="services-three__single">
                        ...
                        <div class="services-three__content">
                            <h3 class="services-three__title"><a href="<?php echo e(route('services')); ?>">Airport transfer</a>
                            </h3>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="services-three__single">
                        ...
                        <div class="services-three__content">
                            <h3 class="services-three__title"><a href="<?php echo e(route('services')); ?>">Fleet leasing</a>
                            </h3>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                    <div class="process-one__single">
                        <div class="process-one__single-bg"
                            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/process-one-single-bg-1(1).jpg')); ?>);">
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="process-one__single">
                        <div class="process-one__single-bg"
                            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/process-one-single-bg-2(1).jpg')); ?>);">
                        </div>
                        <div class="process-one__icon-box">
                            <div class="process-one__icon-shape"></div>
                            <div class="process-one__icon">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms">
                    <div class="process-one__single">
                        <div class="process-one__single-bg"
                            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/process-one-single-bg-3(1).jpg')); ?>);">
                        </div>
                        <div class="process-one__icon-box">
                            <div class="process-one__icon-shape"></div>
                            <div class="process-one__icon">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="700ms" data-wow-duration="1500ms">
                    <div class="process-one__single">
                        <div class="process-one__single-bg"
                            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/process-one-single-bg-4(1).jpg')); ?>);">
    ...
    <section class="counter-three">
        <!-- <div class="counter-three__bg jarallax" data-jarallax data-speed="0.2" data-imgposition="50% 0%"
            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/counter-three-bg.jpg')); ?>);">
        </div> -->
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="listing-three__carousel owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        <div class="listing-three__img">
                            <img src="<?php echo e(asset('assets/images/listing/listing-3-1(1).jpg')); ?>" alt="">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        <div class="listing-three__img">
                            <img src="<?php echo e(asset('assets/images/listing/listing-3-2(1).png')); ?>" alt="">
                            <div class="listing-three__brand-name">
                                <p>Maruti</p>
                            </div>
                        </div>
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Maruti Ertiga VXI CNG</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Maruti Swift LXI</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Mahindra Scorpio S11</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        <div class="listing-three__img">
                            <img src="<?php echo e(asset('assets/images/listing/listing-3-5(1).png')); ?>" alt="">
                            <div class="listing-three__brand-name">
                                <p>Mahindra</p>
                            </div>
                        </div>
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Mahindra Thar 4x4 Diesel</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        <div class="listing-three__img">
                            <img src="<?php echo e(asset('assets/images/listing/listing-3-6(1).png')); ?>" alt="">
                            <div class="listing-three__brand-name">
                                <p>Hyundai</p>
                            </div>
                        </div>
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Hyundai Verna Petrol</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Hyundai i20</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                 ...
                 <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Hyundai i10</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Maruti Swift Dzire</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('listing-single')); ?>">Aura CNG</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
    ...
    <section class="video-one">
        <div class="video-one__bg jarallax" data-jarallax data-speed="0.2" data-imgposition="50% 0%"
            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/video-one-bg (2).jpg')); ?>);"></div>
        <div class="container">
                    ...
                    <div class="testimonial-three__right">
                        <div class="testimonial-three__carousel owl-theme owl-carousel">
                            ...
                            <div class="item">
                                <div class="testimonial-three__single">
                                    <div class="testimonial-three__img">
                                        <img src="<?php echo e(asset('assets/images/testimonial/testimonial-3-1(1).png')); ?>" alt="">
                                    ...
                                    <div class="testimonial-three__client-info">
                                        <div class="testimonial-three__client-content">
                                            <h4 class="testimonial-three__client-name"><a
                                                    href="<?php echo e(route('testimonials')); ?>">Basavaraj Raga</a></h4>
                            ...
                            <div class="item">
                                <div class="testimonial-three__single">
                                    <div class="testimonial-three__img">
                                        <img src="<?php echo e(asset('assets/images/testimonial/testimonial-3-2(1).png')); ?>" alt="">
                                        <div class="testimonial-three__rating">
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                                    ...
                                    <div class="testimonial-three__client-info">
                                        <div class="testimonial-three__client-content">
                                            <h4 class="testimonial-three__client-name"><a
                                                    href="<?php echo e(route('testimonials')); ?>">Arshad Khan</a></h4>
                                            <p class="testimonial-three__client-sub-title">Customer</p>
                                        </div>
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonial-three__single">
                                    <div class="testimonial-three__img">
                                        <img src="<?php echo e(asset('assets/images/testimonial/testimonial-3-3(1).png')); ?>" alt="">
                                        <div class="testimonial-three__rating">
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                                            <span class="fas fa-star"></span>
                                    ...
                                    <div class="testimonial-three__client-info">
                                        <div class="testimonial-three__client-content">
                                            <h4 class="testimonial-three__client-name"><a
                                                    href="<?php echo e(route('testimonials')); ?>">Mayank Singh</a></h4>
                                            <p class="testimonial-three__client-sub-title">Customer</p>
                                        </div>
                                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                    <div class="team-three__single">
                        ...
                        <div class="team-three__content">
                            <h3 class="team-three__name"><a href="<?php echo e(route('driver-details')); ?>">Rishabh</a></h3>
    ...
    <section class="contact-one" id="contact">
        <!-- <div class="contact-one__bg jarallax" data-jarallax data-speed="0.2" data-imgposition="50% 0%"
            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/contact-one-bg.jpg')); ?>);">
        </div> -->
        <div class="contact-one__img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
            <img src="<?php echo e(asset('assets/images/resources/contact-one-img-1(1).png')); ?>" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="contact-one__left">
                        <div class="section-title text-left sec-title-animation animation-style2">
                            <div class="section-title__tagline-box">
                                <div class="section-title__tagline-shape">
                                    <img src="<?php echo e(asset('assets/images/shapes/section-title-tagline-shape-2.png')); ?>" alt="">
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="feature-one__inner-single wow slideInLeft" data-wow-delay="100ms"
                            ...
                            <!-- <div class="feature-one__inner-single-bg"
                                style="background-image: url(<?php echo e(asset('assets/images/backgrounds/feature-one-bg-1.jpg')); ?>);">
                            </div> -->
                            ...
                            <div class="feature-one__inner-btn-box">
                                <a href="<?php echo e(route('contact')); ?>" class="thm-btn">Get Started</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="feature-one__inner-single feature-one__inner-single--two wow slideInRight"
                            ...
                            <!-- <div class="feature-one__inner-single-bg"
                                style="background-image: url(<?php echo e(asset('assets/images/backgrounds/feature-one-bg-2.jpg')); ?>);">
                            </div> -->
                            ...
                            <div class="feature-one__inner-btn-box">
                                <a href="<?php echo e(route('self-drive-car')); ?>" class="thm-btn">Rent Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="brand-one__carousel owl-theme owl-carousel">
                ...
                <div class="item">
                    <div class="brand-one__single">
                        <div class="brand-one__img">
                            <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1-1(1).png')); ?>" alt=""></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="brand-one__single">
                        <div class="brand-one__img">
                            <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1-2(1).png')); ?>" alt=""></a>
                        </div>
                    </div>
                </div>
                <!--Brand One Single End-->
                ...
                <div class="item">
                    <div class="brand-one__single">
                        <div class="brand-one__img">
                            <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1-3(1).png')); ?>" alt=""></a>
                        </div>
                    </div>
                </div>
                <!--Brand One Single End-->
                ...
                <div class="item">
                    <div class="brand-one__single">
                        <div class="brand-one__img">
                            <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1-4(1).png')); ?>" alt=""></a>
                        </div>
                    </div>
                </div>
                <!--Brand One Single End-->
                ...
                <div class="item">
                    <div class="brand-one__single">
                        <div class="brand-one__img">
                            <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1-5(1).png')); ?>" alt=""></a>
                        </div>
                    </div>
                </div>
                <!--Brand One Single End-->
                ...
                <div class="item">
                    <div class="brand-one__single">
                        <div class="brand-one__img">
                            <a href="#"><img src="<?php echo e(asset('assets/images/brand/brand-1-6(1).png')); ?>" alt=""></a>
                        </div>
                    </div>
                </div>
                <!--Brand One Single End-->
    ...
    <section class="download-app-one">
        <!-- <div class="download-app-one__bg jarallax" data-jarallax data-speed="0.2" data-imgposition="50% 0%"
            style="background-image: url(<?php echo e(asset('assets/images/backgrounds/download-app-one-bg.jpg')); ?>);"></div> -->
        <div class="container">
                    ...
                    <div class="col-xl-7 col-lg-7">
                        <div class="download-app-one__content sec-title-animation animation-style2">
                            ...
                            <div class="download-app-one__google-and-app-store">
                                <a href="<?php echo e(route('contact')); ?>"><img
                                        src="<?php echo e(asset('assets/images/icon/download-app-img1.png')); ?>" alt=""></a>
                                <a href="<?php echo e(route('contact')); ?>"><img
                                        src="<?php echo e(asset('assets/images/icon/download-app-img2.png')); ?>" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="download-app-one__right">
                            <div class="download-app-one__img">
                                <div class="download-app-one__img1 reveal">
                                    <img src="<?php echo e(asset('assets/images/resources/download-app-img-1.png')); ?>" alt="">
                                </div>
                            </div>
                            <div class="download-app-one-car__img float-bob-x">
                                <img src="<?php echo e(asset('assets/images/resources/download-app-car-img-1(1).png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="gallery-one__single">
                    <div class="gallery-one__img">  
                        ...
                        <a href="<?php echo e(route('cars')); ?>"><span class="fab fa-instagram"></span></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/home/index3-one-page.blade.php ENDPATH**/ ?>