            ...
            <div class="listing-three__carousel owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Hyundai i20</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                 ...
                 <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Hyundai i10</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Maruti Swift Dzire</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Aura CNG</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
