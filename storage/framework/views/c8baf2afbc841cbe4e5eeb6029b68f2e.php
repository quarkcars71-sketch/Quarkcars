            ...
            <div class="listing-three__carousel owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('swift-vxi-details')); ?>">Maruti Swift VXI (O) CNG</a></h3>
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('hyundai-i20-details')); ?>">Hyundai i20</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                            ...
                            <div class="listing-three__car-rent-and-btn-box">
                                <p class="listing-three__car-rent"><span>2800 INR/</span> Day</p>
                                <div class="listing-three__btn-box">
                                    <a href="<?php echo e(route('hyundai-i20-details')); ?>" class="listing-three__btn"><span
                                            class="icon-right-arrow-1"></span></a>
                                </div>
                            </div>
                        </div>
                 ...
                 <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('hyundai-i10-details')); ?>">Hyundai i10</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                            ...
                            <div class="listing-three__car-rent-and-btn-box">
                                <p class="listing-three__car-rent"><span>2500 INR/</span> Day</p>
                                <div class="listing-three__btn-box">
                                    <a href="<?php echo e(route('hyundai-i10-details')); ?>" class="listing-three__btn"><span
                                            class="icon-right-arrow-1"></span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('maruti-swift-dzire-details')); ?>">Maruti Swift Dzire</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                            ...
                            <div class="listing-three__car-rent-and-btn-box">
                                ...
                                <div class="listing-three__btn-box">
                                    <a href="<?php echo e(route('maruti-swift-dzire-details')); ?>" class="listing-three__btn"><span
                                            class="icon-right-arrow-1"></span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="item">
                    <div class="listing-three__single">
                        ...
                        <div class="listing-three__content">
                            <h3 class="listing-three__title"><a href="<?php echo e(route('aura-cng-details')); ?>">Aura CNG</a></h3>
                            <div class="listing-three__meta-box-info">
                                <ul class="list-unstyled listing-three__meta">
                                    <li>
                                        <div class="icon">
                            ...
                            <div class="listing-three__car-rent-and-btn-box">
                                <p class="listing-three__car-rent"><span>2500 INR/</span> Day</p>
                                <div class="listing-three__btn-box">
                                    <a href="<?php echo e(route('aura-cng-details')); ?>" class="listing-three__btn"><span
                                            class="icon-right-arrow-1"></span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="feature-one__inner-single feature-one__inner-single--two wow slideInRight"
                            ...
                            <div class="feature-one__inner-btn-box">
                                <a href="<?php echo e(route('https://wa.me/message/ZS5QNMAR2NSCO1')); ?>" class="thm-btn">Rent Now</a>
                            </div>
                        </div>
                    </div>
                </div>
