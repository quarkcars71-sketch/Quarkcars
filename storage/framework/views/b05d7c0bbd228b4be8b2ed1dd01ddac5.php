                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-one__single">
                                    ...
                                    <div class="listing-one__content">
                                        <h3 class="listing-one__title"><a href="<?php echo e(route('maruti-dzire-tour-cng-details')); ?>">Maruti Dzire Tour CNG</a></h3>
                                        <div class="listing-one__meta-box-info">
                                            <ul class="list-unstyled listing-one__meta">
                                                <li>
                                                    <div class="icon">
                                        ...
                                        <div class="listing-one__btn-box">
                                            <a href="<?php echo e(route('maruti-dzire-tour-cng-details')); ?>" class="thm-btn">Details Now<span
                                                    class="fas fa-arrow-right"></span></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-one__single">
                                    ...
                                    <div class="listing-one__content">
                                        <h3 class="listing-one__title"><a href="<?php echo e(route('maruti-brezza-details')); ?>">Maruti Brezza</a></h3>
                                        <div class="listing-one__meta-box-info">
                                            <ul class="list-unstyled listing-one__meta">
                                                <li>
                                                    <div class="icon">
                                        ...
                                        <div class="listing-one__btn-box">
                                            <a href="<?php echo e(route('maruti-brezza-details')); ?>" class="thm-btn">Details Now<span
                                                    class="fas fa-arrow-right"></span></a>
                                        </div>
                                    </div>
                                </div>
