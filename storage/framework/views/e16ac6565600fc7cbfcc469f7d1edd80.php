<?php $__env->startSection('title', 'Cancellation Policy || Quarkcars || Quarkcars Laravel Template'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Privacy Policy','subtitle' => 'Privacy policy']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Privacy Policy','subtitle' => 'Privacy policy']); ?>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/pages/cancellation-policy.blade.php ENDPATH**/ ?>