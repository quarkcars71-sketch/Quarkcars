                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        ...
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Dausa</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            ...
                                            <div class="listing-two__btn-box">
                                                <a href="<?php echo e(route('listing-single')); ?>" class="thm-btn">Book Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Alwar</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Bharatpur</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Ajmer</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Sawai Madhopur </a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Khatu Shyam Ji</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Tonk</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Sikar</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    ...
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Nagaur</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    <div class="listing-two__img-box">
                                        <div class="listing-two__img">
                                            <img src="<?php echo e(asset('assets/images/listing/listing-2-2.jpg')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur -  Mahuwa</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    <div class="listing-two__img-box">
                                        <div class="listing-two__img">
                                            <img src="<?php echo e(asset('assets/images/listing/listing-2-3.jpg')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur
                                             - sariska
                                        </a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    <div class="listing-two__img-box">
                                        <div class="listing-two__img">
                                            <img src="<?php echo e(asset('assets/images/listing/listing-2-4.jpg')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Pushkar</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    <div class="listing-two__img-box">
                                        <div class="listing-two__img">
                                            <img src="<?php echo e(asset('assets/images/listing/listing-2-5.jpg')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Kishangarh</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    <div class="listing-two__img-box">
                                        <div class="listing-two__img">
                                            <img src="<?php echo e(asset('assets/images/listing/listing-2-6.jpg')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - udaipur</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="listing-two__single">
                                    <div class="listing-two__img-box">
                                        <div class="listing-two__img">
                                            <img src="<?php echo e(asset('assets/images/listing/listing-2-7.jpg')); ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="listing-two__content">
                                        <p class="listing-two__sub-title">Maruti Swift VXI</p>
                                        <h3 class="listing-two__title"><a href="<?php echo e(route('listing-single')); ?>">Jaipur - Delhi</a>
                                        </h3>
                                        <div class="listing-two__price-and-btn">
                                            <div class="listing-two__price-box">
                                                <span>From</span>
