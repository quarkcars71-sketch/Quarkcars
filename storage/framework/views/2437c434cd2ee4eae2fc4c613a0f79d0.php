<?php $__env->startSection('title', 'Ertiga VXI Details || Quarkcars'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pageHeader','data' => ['title' => 'Ertiga VXI Details','subtitle' => 'Ertiga VXI CNG']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Ertiga VXI Details','subtitle' => 'Ertiga VXI CNG']); ?>
                                        ...
                                        <div class="col-xl-5 col-lg-5">
                                            <div class="listing-single__left">
                                                <div class="listing-single__img">
                                                    <img src="<?php echo e(asset('assets/images/listing/listing-3-2(1).png')); ?>"
                        ...
                        <div class="listing-single__sidebar">
                            ...
                            <div class="listing-single__rent-car listing-single__single-box">
                                ...
                                <div class="listing-single__btn-box-2">
                                    <a href="<?php echo e(route('ertiga-vxi-details')); ?>" class="thm-btn">Rent Now<span
                                            class="fas fa-arrow-right"></span></a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.layoutCommon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pack-file laravel\Quarkcars\resources\views/pages/ErtigaVXIDetails.blade.php ENDPATH**/ ?>